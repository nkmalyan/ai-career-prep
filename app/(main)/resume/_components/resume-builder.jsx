      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="preview">
          ...
          {activeTab === "preview" && resumeMode !== "preview" && (
             <Alert variant="default | destructive" className="border-2 border-orange-500 mb-2 flex gap-1 flex-col md:flex-row">
                <div className="flex flex-row gap-2 items-center">
                <AlertTriangle className="h-4 w-4" color="#ff0000"/>
                <AlertTitle className="text-red-500 flex">Alert!</AlertTitle>
                </div>
                <AlertDescription>
